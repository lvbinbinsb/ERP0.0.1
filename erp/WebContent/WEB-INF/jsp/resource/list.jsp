...
<script type="text/javascript">
	...
	function showMsg(msg,uuid){
		...
		top.$('hid-action').value="${pageContext.request.contextPath}/resource/delete.do?uuid="+uuid;
		top.lock.show();
	}
</script>
			...
			<div class="square-order">
				...
				<c:forEach items="${resList}" var="res">
					<tr align="center" bgcolor="#FFFFFF">
						<td width="13%" height="30">${res.name }</td>
						<td>action访问</td>
						<td>可访问</td>
						<td align="left">${res.url }</td>
						<td>
							<img src="${pageContext.request.contextPath }/images/icon_3.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a href="${pageContext.request.contextPath }/resource/toEdit.do?uuid=${res.uuid}" class="xiu">修改</a>
							</span> 
							<img src="${pageContext.request.contextPath }/images/icon_04.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a href="javascript:void(0)" class="xiu" onclick="showMsg('是否删除该项数据？',${res.uuid})">删除</a>
							</span>
						</td>
					</tr>
				</c:forEach>	
