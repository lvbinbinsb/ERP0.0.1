...
$(function() {
	...
	function reloads(){
		...
		window.location.href="${pageContext.request.contextPath }/dep/update.do?uuid=${dep.uuid}";
	}
 ...
 <body>
	...
	<div class="content-text">
		<div class="square-order">
			<form action="${pageContext.request.contextPath }/dep/updatedep.do" method="post" id="saves">
