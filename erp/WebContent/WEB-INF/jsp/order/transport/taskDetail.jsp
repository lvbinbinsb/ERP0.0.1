...
<input name="orderuuid" value="${orderuuid }">
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td class="order_show_msg">${info.gysname }</td>
						<td height="30">订单类别:</td>
						<td class="order_show_msg">采购(废弃)</td>
						<td>提货方式:</td>
						<td class="order_show_msg">${info.needs==1?'送货':'自提' }</td>
						<td>订 单 号:</td>
						<td class="order_show_msg" colspan="2">${info.orderNum }</td>
					</tr>
					<tr>
						<td>联&nbsp;系&nbsp;人:</td>
						<td class="order_show_msg">${info.contact }</td>
						<td>联系方式:</td>
						<td class="order_show_msg">${info.tele }</td>
						<td>商品总量:</td>
			...
			<div class="square-order">
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					<tr align="center"
						...
						<tr align="center" bgcolor="#FFFFFF">
							<td height="30">${goodsinfo.goodstypename }</td>
