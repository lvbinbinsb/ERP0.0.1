			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td class="order_show_msg">${orderDto.gysname }</td>
						<td>下单时间:</td>
						<td class="order_show_msg">${orderDto.createtimeView }</td>
						<td>下 单 人:</td>
						<td class="order_show_msg">${orderDto.zdrname }</td>
						<td>订 单 号:</td>
						<td class="order_show_msg" colspan="2">${orderDto.ordernum }</td>
					</tr>
					<tr>
						...
						<td>订单总额:</td>
						<td class="order_show_msg">${orderDto.totalprice }  元</td>
					</tr>
				</table>
			</div>
			<!--"square-o-top"end-->
